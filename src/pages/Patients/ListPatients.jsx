...
const columns = [
  ...
  { id: 'name', label: 'Full Name', minWidth: 140 },
  { id: 'age', label: "Age", min: 100 },
  { id: 'gender', label: "Gender", min: 100 },
  { id: 'currentMedications', label: 'CurrentMedications', minWidth: 170 }
];
                ...
                .map((row) => {
                  return (
                    <TableRow hover role="checkbox" tabIndex={-1} key={row.code}>
                      ...
                      <TableCell>
                          <Button href='patients/list/:patient'>
                            Detail
                          </Button>
                        </TableCell>
                    </TableRow>
